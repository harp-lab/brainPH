...
def compute_distances_between_cohorts(matrices,
                                      ...
                                      end_subject=None,
                                      distance_method='ed',
                                      output_directory='output_non_tda_random'):
...
if __name__ == "__main__":
    get_user_input()
    # python non_tda_random_distance_calculation.py --method ed --start 1 --end 316 --distance y --mds y
