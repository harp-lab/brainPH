...
for m = 1:316
    ...
    if count_positive > 0
        disp("Subject "+m+ "_subject_mx645 positive: "+ count_positive);
    end
    ...
    if count_positive > 0
        disp("Subject "+m+ "_subject_mx1400 positive: "+ count_positive);
    end
    ...
    if count_positive > 0
        disp("Subject "+m+ "_std2500 positive: "+ count_positive);
    end
